...
class VLOG_Adsense_Widget extends WP_Widget { 
	...
	function __construct() {
		$widget_ops = array( 'classname' => 'vlog_adsense_widget', 'description' => esc_html__('You can place Google AdSense or any JavaScript related code inside this widget', 'vlog-buddy') );
		$control_ops = array( 'id_base' => 'vlog_adsense_widget' );
		parent::__construct( 'vlog_adsense_widget', esc_html__('Vlog Adsense', 'vlog-buddy'), $widget_ops, $control_ops );
	...
	function form( $instance ) {
		...
		<p>
			...
			<small class="howto"><?php esc_html_e('Leave empty for no title', 'vlog-buddy'); ?></small>
		</p>
		
		<p>
			<label for="<?php echo esc_attr($this->get_field_id( 'adsense_code' )); ?>"><?php esc_html_e('Adsense Code', 'vlog-buddy'); ?>:</label>
			...
			<small class="howto"><?php esc_html_e('Place your Google Adsense code or any JavaScript related advertising code.', 'vlog-buddy'); ?></small>
		</p>
		...
		<p>	
			<label for="<?php echo esc_attr( $this->get_field_id( 'expand' ) ); ?>">
				...
				<?php esc_html_e('Expand widget area to 300px', 'vlog-buddy'); ?>
			</label>
			<small class="howto"><?php esc_html_e('Check this option if you are using 300px wide adsense so it can fit your widget area', 'vlog-buddy'); ?></small>
