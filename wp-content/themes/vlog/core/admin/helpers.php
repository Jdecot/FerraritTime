...
if ( !function_exists( 'vlog_get_main_layouts' ) ):
	function vlog_get_main_layouts( $inherit = false, $none = false, $exclude = array() ) {
		...
		if ( $inherit ) {
			$layouts['inherit'] = array( 'title' => esc_html__( 'Inherit', 'vlog' ), 'img' => get_parent_theme_file_uri( '/assets/img/admin/inherit.png' ), 'col' => 0 );
		}

		if ( $none ) {
			$layouts['none'] = array( 'title' => esc_html__( 'None', 'vlog' ), 'img' => get_parent_theme_file_uri( '/assets/img/admin/none.png' ), 'col' => 0 );
		}

		$layouts['a'] = array( 'title' => esc_html__( 'Layout A', 'vlog' ), 'img' => get_parent_theme_file_uri( '/assets/img/admin/layout_a.png' ), 'col' => 12 );
		$layouts['b'] = array( 'title' => esc_html__( 'Layout B', 'vlog' ), 'img' => get_parent_theme_file_uri( '/assets/img/admin/layout_b.png' ), 'col' => 12 );
		$layouts['c'] = array( 'title' => esc_html__( 'Layout C', 'vlog' ), 'img' => get_parent_theme_file_uri( '/assets/img/admin/layout_c.png' ), 'col' => 6 );
		$layouts['d'] = array( 'title' => esc_html__( 'Layout D', 'vlog' ), 'img' => get_parent_theme_file_uri( '/assets/img/admin/layout_d.png' ), 'col' => 6 );
		$layouts['e'] = array( 'title' => esc_html__( 'Layout E', 'vlog' ), 'img' => get_parent_theme_file_uri( '/assets/img/admin/layout_e.png' ), 'col' => 4 );
		$layouts['f'] = array( 'title' => esc_html__( 'Layout F', 'vlog' ), 'img' => get_parent_theme_file_uri( '/assets/img/admin/layout_f.png' ), 'col' => 4 );
		$layouts['g'] = array( 'title' => esc_html__( 'Layout G', 'vlog' ), 'img' => get_parent_theme_file_uri( '/assets/img/admin/layout_g.png' ), 'col' => 3 );
		$layouts['h'] = array( 'title' => esc_html__( 'Layout H', 'vlog' ), 'img' => get_parent_theme_file_uri( '/assets/img/admin/layout_h.png' ), 'col' => 3 );
...
if ( !function_exists( 'vlog_get_featured_layouts' ) ):
	function vlog_get_featured_layouts( $inherit = false, $none = false, $exclude = array() ) {
		...
		if ( $inherit ) {
			$layouts['inherit'] = array( 'title' => esc_html__( 'Inherit', 'vlog' ), 'img' => get_parent_theme_file_uri( '/assets/img/admin/inherit.png' ) );
		}

		if ( $none ) {
			$layouts['none'] = array( 'title' => esc_html__( 'None', 'vlog' ), 'img' => get_parent_theme_file_uri( '/assets/img/admin/none.png') );
		}

		$layouts['1'] = array( 'title' => esc_html__( 'Layout 1', 'vlog' ), 'img' => get_parent_theme_file_uri( '/assets/img/admin/layout_fa1.png' ) );
		$layouts['2'] = array( 'title' => esc_html__( 'Layout 2', 'vlog' ), 'img' => get_parent_theme_file_uri( '/assets/img/admin/layout_fa2.png' ) );
		$layouts['3'] = array( 'title' => esc_html__( 'Layout 3', 'vlog' ), 'img' => get_parent_theme_file_uri( '/assets/img/admin/layout_fa3.png' ) );
		$layouts['4'] = array( 'title' => esc_html__( 'Layout 4', 'vlog' ), 'img' => get_parent_theme_file_uri( '/assets/img/admin/layout_fa4.png' ) );
		$layouts['5'] = array( 'title' => esc_html__( 'Layout 5', 'vlog' ), 'img' => get_parent_theme_file_uri( '/assets/img/admin/layout_fa5.png' ) );
		$layouts['custom'] = array( 'title' => esc_html__( 'Custom Content', 'vlog' ), 'img' => get_parent_theme_file_uri( '/assets/img/admin/layout_fa_custom.png' ) );
...
if ( !function_exists( 'vlog_get_single_layouts' ) ):
	function vlog_get_single_layouts( $inherit = false, $exclude = array() ) {
		...
		$layouts['none'] = array( 'title' => esc_html__( 'Classic', 'vlog' ), 'img' => get_parent_theme_file_uri( '/assets/img/admin/layout_classic.png') );
		$layouts['1'] = array( 'title' => esc_html__( 'Cover 1', 'vlog' ), 'img' => get_parent_theme_file_uri( '/assets/img/admin/layout_fa1.png') ) ;
		$layouts['2'] = array( 'title' => esc_html__( 'Cover 2', 'vlog' ), 'img' => get_parent_theme_file_uri( '/assets/img/admin/layout_fa2.png') );
...
if ( !function_exists( 'vlog_get_cat_layouts' ) ):
	function vlog_get_cat_layouts( $inherit = false ) {
		...
		$layouts['c'] = array( 'title' => esc_html__( '2 Columns', 'vlog' ), 'img' => get_parent_theme_file_uri( '/assets/img/admin/layout_c.png' ), 'col' => 6 );
		$layouts['e'] = array( 'title' => esc_html__( '3 Columns', 'vlog' ), 'img' => get_parent_theme_file_uri( '/assets/img/admin/layout_e.png' ), 'col' => 4 );
		$layouts['g'] = array( 'title' => esc_html__( '4 Columns', 'vlog' ), 'img' => get_parent_theme_file_uri( '/assets/img/admin/layout_g.png' ), 'col' => 3 );
...
if ( !function_exists( 'vlog_get_sidebar_layouts' ) ):
	function vlog_get_sidebar_layouts( $inherit = false ) {
		...
		$layouts['none'] = array( 'title' => esc_html__( 'None', 'vlog' ), 'img' => get_parent_theme_file_uri( '/assets/img/admin/none.png' ) );
		$layouts['left'] = array( 'title' => esc_html__( 'Left sidebar', 'vlog' ), 'img' => get_parent_theme_file_uri( '/assets/img/admin/content_sid_left.png' ) );
		$layouts['right'] = array( 'title' => esc_html__( 'Right sidebar', 'vlog' ), 'img' => get_parent_theme_file_uri( '/assets/img/admin/content_sid_right.png' ) );
...
if ( !function_exists( 'vlog_get_pagination_layouts' ) ):
	function vlog_get_pagination_layouts( $inherit = false, $none = false ) {
		...
		$layouts['numeric'] = array( 'title' => esc_html__( 'Numeric pagination links', 'vlog' ), 'img' => get_parent_theme_file_uri( '/assets/img/admin/pag_numeric.png' ) );
		$layouts['prev-next'] = array( 'title' => esc_html__( 'Prev/Next page links', 'vlog' ), 'img' => get_parent_theme_file_uri( '/assets/img/admin/pag_prev_next.png' ) );
		$layouts['load-more'] = array( 'title' => esc_html__( 'Load more button', 'vlog' ), 'img' => get_parent_theme_file_uri( '/assets/img/admin/pag_load_more.png' ) );
		$layouts['infinite-scroll'] = array( 'title' => esc_html__( 'Infinite scroll', 'vlog' ), 'img' => get_parent_theme_file_uri( '/assets/img/admin/pag_infinite.png' ) );
...
if ( !function_exists( 'vlog_get_module_columns' ) ):
	function vlog_get_module_columns() {
		...
		$options['12'] = array( 'title' => esc_html__( '1/1', 'vlog' ), 'img' => get_parent_theme_file_uri( '/assets/img/admin/col_12.png' ) );
		$options['6'] = array( 'title' => esc_html__( '1/2', 'vlog' ), 'img' => get_parent_theme_file_uri( '/assets/img/admin/col_6.png' ) );
		$options['4'] = array( 'title' => esc_html__( '1/3', 'vlog' ), 'img' => get_parent_theme_file_uri( '/assets/img/admin/col_4.png' ) );
		$options['8'] = array( 'title' => esc_html__( '2/3', 'vlog' ), 'img' => get_parent_theme_file_uri( '/assets/img/admin/col_8.png' ) );
		$options['3'] = array( 'title' => esc_html__( '1/4', 'vlog' ), 'img' => get_parent_theme_file_uri( '/assets/img/admin/col_3.png' ) );
		$options['9'] = array( 'title' => esc_html__( '3/4', 'vlog' ), 'img' => get_parent_theme_file_uri( '/assets/img/admin/col_9.png' ) );
...
if ( !function_exists( 'vlog_get_action_opts' ) ):
	function vlog_get_action_opts(	$default = array() ) {
		...
		$options['subscribe'] = esc_html__( 'Subscribe', 'vlog' );
		if(!empty($default)){
			foreach($options as $key => $option){
				if(in_array( $key, $default)){
					$options[$key] = 1;
...
if ( !function_exists( 'vlog_get_sticky_header_menus' ) ):
	function vlog_get_sticky_header_menus() {

		$options = array();

		$options['vlog_main_menu'] = esc_html__( 'Main Menu', 'vlog' );
		$options['vlog_secondary_menu_1'] = esc_html__( 'Secondary Menu 1', 'vlog' );
		$options['vlog_secondary_menu_2'] = esc_html__( 'Secondary Menu 2', 'vlog' );
		$options['0'] = esc_html__( 'None', 'vlog' );

		$options = apply_filters('vlog_modify_sticky_header_menus', $options ); //Allow child themes or plugins to modify
		return $options;
	}
endif;
...
if ( !function_exists( 'vlog_get_header_special_elements' ) ):
	function vlog_get_header_special_elements( $default = array(), $exclude = array() ) {
		...
		$options['watch-later'] = esc_html__( 'Watch later', 'vlog' );
		$options['listen-later'] = esc_html__( 'Listen later', 'vlog' );
		$options['social-menu-drop'] = esc_html__( 'Social menu (button)', 'vlog' );
		$options['social-menu'] = esc_html__( 'Social menu (list)', 'vlog' );
		$options['login-form'] = esc_html__( 'Login form (icon/dropdown)', 'vlog' );
		if ( vlog_is_woocommerce_active() ){
			$options['cart-icon'] = esc_html__( 'WooCommerce cart icon', 'vlog' );
		}
...
if ( !function_exists( 'vlog_get_update_notification' ) ):
	function vlog_get_update_notification() {
		...
		if ( isset( $current->response['vlog'] ) ) {
			...
			$message_html = '<a class="theme-version-label" href="https://mekshq.com/docs/vlog-change-log" target="blank">Version '.VLOG_THEME_VERSION.'</a>';
		}
...
if ( !function_exists( 'vlog_get_admin_js_settings' ) ):
	function vlog_get_admin_js_settings() {
		...
		$js_settings['is_gutenberg'] = vlog_is_gutenberg_page();
 ...
 * @since  1.7.2
 */
if ( !function_exists( 'vlog_is_envato_market_active' ) ):
	function vlog_is_envato_market_active() {
 ...
 * @since  1.0
 */
if ( !function_exists( 'vlog_is_redux_active' ) ):
	function vlog_is_redux_active() {
 ...
 * @since  1.0
 */
if ( !function_exists( 'vlog_get_breadcrumbs_options' ) ):
	function vlog_get_breadcrumbs_options() {

		$options['none'] = esc_html__( 'None', 'vlog' );
		$options[ ( vlog_is_yoast_active() ) ? 'yoast' : 'yoast-disabled' ] = esc_html__( 'Yoast SEO (or Yoast Breadcrumbs)', 'vlog' );
		$options[ ( vlog_is_breadcrumbs_navxt_active() ) ? 'bcn' : 'bcn-disabled' ] = esc_html__( 'Breadcrumb NavXT', 'vlog' );

		$options = apply_filters( 'vlog_modify_breadcrumbs_options', $options );
