...
<div id="vlog-sticky-header-2" class="vlog-sticky-header vlog-stycky-header-2 vlog-site-header <?php echo esc_attr( $shadow_class ); ?> vlog-header-bottom hidden-xs hidden-sm">
