<article <?php post_class('vlog-lay-e vlog-cat col-lg-4 col-sm-4 col-md-4 col-xs-12'); ?>>
	...
	<?php if( $fimg = vlog_get_taxonomy_featured_image('vlog-lay-e', $cat->term_id, $module_type) ) : ?>
	...
	<div class="entry-header">
	    <h2 class="entry-title h5"><a href="<?php echo esc_url( get_term_link( $cat->term_id ) ); ?>"><?php echo esc_html($cat->name); ?></a></h2>
	</div>
